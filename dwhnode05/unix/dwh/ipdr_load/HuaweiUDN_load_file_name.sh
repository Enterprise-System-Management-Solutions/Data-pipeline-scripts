...
INSERT INTO L1_HUAWEIUDN_NEW(PROCESSED_DATE,FILE_NAME,IP1_STARTTIME,IP2_ENDTIME,IP4_IMSI,IP5_MSISDN,IP6_IMEISV,IP7_MS_IP,IP8_SERVER_IP,IP9_MS_PORT,IP10_SERVER_PORT,IP12_APN,IP14_RAT_TYPE,IP15_SERVING_NODE_IP,IP16_GATEWAY_NODE_IP,IP17_CGI,IP18_SAI,IP19_RAI,IP20_TAI,IP21_ECGI,IP22_LAI,IP23_UPLINK_TRAFFIC,IP24_DOWNLINK_TRAFFIC,IP27_PROTOCOL_CATEGORY,IP28_APPLICATION,IP29_SUB_APPLICATION,IP30_EGN_SUB_PROTOCOL,IP31_URL,IP32_USER_AGENT)
(SELECT TO_DATE(TO_CHAR(SYSDATE,'MM/DD/YYYY'),'MM/DD/YYYY'),'$1',STARTTIME,ENDTIME,IMSI,MSISDN,IMEISV,MS_IP,SERVER_IP,MS_PORT,SERVER_PORT,APN,RAT_TYPE,SERVING_NODE_IP,GATEWAY_NODE_IP,CGI,SAI,RAI,TAI,ECGI,LAI,UPLINK_TRAFFIC,DOWNLINK_TRAFFIC,PROTOCOL_CATEGORY,APPLICATION,SUB_APPLICATION,EGN_SUB_PROTOCOL,URL,USER_AGENT FROM EXT_HUAWEIUDN)
/
COMMIT
/
UPDATE cdr_head
