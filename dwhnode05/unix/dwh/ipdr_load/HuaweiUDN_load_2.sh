...
(SELECT TO_DATE(TO_CHAR(SYSDATE,'MM/DD/YYYY'),'MM/DD/YYYY'), TO_CHAR(SYSDATE, 'HH24') AS PROCESSED_HOUR, '$2', STARTTIME, ENDTIME, MS_IP, MS_PORT, SERVER_IP, SERVER_PORT, MSISDN, IMSI, IMEISV, CGI, SAI, ECGI, UPLINK_TRAFFIC, DOWNLINK_TRAFFIC,RAT_TYPE,RAI,TAI,LAI,SAC,LAC  FROM EXT_HUAWEIUDN2 )
/
COMMIT
/
UPDATE cdr_head
...
lock=/data02/scripts/dwh/lock/HuaweiUDN2_load_lock  export lock
