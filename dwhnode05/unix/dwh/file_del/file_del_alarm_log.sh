...
lock=/data02/scripts/dwh/lock/alarm_log_delete_lock  export lock
...
cd /data04/ipdr_u2000/alarm/process_dir
...
SET head off
SET feedback off
select process_status from cdr_head where source ='alarm' and file_name='$f';
EOF`
