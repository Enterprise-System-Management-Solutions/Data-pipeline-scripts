--
-- P_L1_TO_L3_EVCREC_MANUAL  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L3_EVCREC_MANUAL (P_PROCESS_DATE VARCHAR2) IS
    VCOUNT NUMBER;
    VDATE_KEY NUMBER;
...
BEGIN
    ...
    WHERE DATE_KEY = (SELECT A.DATE_KEY FROM DATE_DIM A WHERE A.DATE_VALUE = VDATE);
     ...
     VALUES              ('L3_EVCREC',VDATE_KEY,'evcREC','34',VCOUNT,'','',SYSDATE);
    COMMIT;
EXCEPTION
