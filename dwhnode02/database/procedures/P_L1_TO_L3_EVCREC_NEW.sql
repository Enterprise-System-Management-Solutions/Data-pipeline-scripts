--
-- P_L1_TO_L3_EVCREC_NEW  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L3_EVCREC_NEW (P_PROCESS_DATE VARCHAR2) IS
    VCOUNT NUMBER;
    VDATE_KEY NUMBER;
    VSTATUS NUMBER;
...
BEGIN
    ...
    WHERE DATE_KEY = (SELECT A.DATE_KEY FROM DATE_DIM A WHERE A.DATE_VALUE = VDATE);
        ...
        VALUES    ('L3_EVCREC',VDATE_KEY,'evcREC','96',VCOUNT,'','',SYSDATE);
        COMMIT;
EXCEPTION
