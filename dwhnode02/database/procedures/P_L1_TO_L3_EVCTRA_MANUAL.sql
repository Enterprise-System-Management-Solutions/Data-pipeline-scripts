--
-- P_L1_TO_L3_EVCTRA_MANUAL  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L3_EVCTRA_MANUAL (P_PROCESS_DATE VARCHAR2) IS
    VCOUNT NUMBER;
    VDATE_KEY NUMBER;
    VSTATUS NUMBER;
...
INSERT INTO L3_EVCTRA
        ...
        VALUES    ('L3_EVCTRA',VDATE_KEY,'evcTRA','96',VCOUNT,'','',SYSDATE);
        COMMIT;
