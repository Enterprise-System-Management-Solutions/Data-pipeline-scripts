...
lock=/data02/scripts/process/bin/laila/l3  export lock
...
xdir=/data02/scripts/process/bin/laila/csv/l3_transfer_count.csv
...
SELECT  /*+PARALLEL(V,10)*/ DD.DATE_VALUE,COUNT(*) FROM L3_TRANSFER V,DATE_DIM DD
