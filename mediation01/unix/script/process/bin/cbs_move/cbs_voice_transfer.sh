...
lock=/data02/script/process/bin/cbs_cdr_transfer_voice  export lock
...
FILES=`find . -maxdepth 1 -type f -name "cbs_cdr_voice*.add" -mmin +5 -mmin -10 | xargs -r ls -l | awk -F" " {'print $9'}`
for i in $FILES
do
