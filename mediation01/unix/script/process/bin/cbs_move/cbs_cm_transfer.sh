...
lock=/data02/script/process/bin/cbs_cdr_transfer_cm  export lock
...
FILES=`find . -maxdepth 1 -type f -name "cbs_cdr_cm*.add" -mmin +5 -mmin -10 | xargs -r ls -l | awk -F" " {'print $9'}`
for i in $FILES
do
