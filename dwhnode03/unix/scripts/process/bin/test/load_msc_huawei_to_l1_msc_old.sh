...
SELECT /*+ PARALLEL (A,16) */ TO_DATE(TO_CHAR(SYSDATE-1, 'MM/DD/YYYY'), 'MM/DD/YYYY') AS PROCESSED_DATE, FILE_NAME, MH01_CALLTYPE, MH02_SERVEDIMSI, MH03_SERVEDIMEI, LPAD(MH04_APARTYMSISDN,13,880), MH05_BPARTYMSISDN, MH06_FORWARDINGMSISDN, '20'||MH07_ORIGINATIONTIME, MH08_CALLDURATION, MH10_GLOBAAREAID, MH11_LAST_LOCATION, MH09_CAUSEFORTERM
