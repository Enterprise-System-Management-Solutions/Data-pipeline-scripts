...
lock=/data02/scripts/process/bin/delete_pro_smsc  export lock
...
cd /data02/mfs/smsc/process_dir
...
SET head off
SET feedback off
select process_status from cdr_head where source='smsc' and file_name='$f';
EOF`
