...
lock=/data02/scripts/process/bin/delete_pro_ussd  export lock
...
cd /data02/mfs/ussd/process_dir
...
SET head off
SET feedback off
select process_status from cdr_head where source='ussd' and file_name='$f';
EOF`
