...
lock=/data02/scripts/process/bin/delete_pro_msc_alu  export lock
...
cd /data02/sftp_msc/alu/dump_dir 
...
SET head off
SET feedback off
select process_status from cdr_head_merge where source='msc_alu' and file_name='$f';
EOF`
