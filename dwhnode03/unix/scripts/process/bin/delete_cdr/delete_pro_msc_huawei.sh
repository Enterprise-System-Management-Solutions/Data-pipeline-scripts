...
lock=/data02/scripts/process/bin/delete_pro_msc_huawei  export lock
...
cd /data02/sftp_msc/huawei/dump_dir
...
SET head off
SET feedback off
select process_status from cdr_head_merge where source='msc_huawei' and file_name='$f';
EOF`
