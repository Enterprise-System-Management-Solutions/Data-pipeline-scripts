--
-- SP_LUHN_ALG  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER03.SP_LUHN_ALG( IN_DATE_KEY VARCHAR2,IN_MSISDN VARCHAR2,IN_IMEI VARCHAR2,IMSI VARCHAR2 ) AS
   ...
   BEGIN
       IF LANTH_RETURN > 16 THEN
        INSERT INTO IMEI_FCT_LD(DATE_KEY, MSISDN, IMEI, RAW_IIMEI, IMSI)
