--
-- P_L1_TO_L2_RECURRING_MANUAL_ETL  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L2_RECURRING_MANUAL_ETL (P_PROCESS_DATE VARCHAR2) IS
    VCOUNT NUMBER;
    VDATE_KEY NUMBER;
    VSTATUS NUMBER;
    VSTATUS2 NUMBER;
...
BEGIN
  ...
  IF VCOUNT >= 1  THEN
    ...
    IF VSTATUS = 96 AND VSTATUS2=0 THEN
        ...
        AND TO_DATE(I.PROCESSED_DATE,'DD/MM/RRRR') = VDATE;
        COMMIT;
