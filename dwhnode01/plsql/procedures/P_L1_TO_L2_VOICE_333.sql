--
-- P_L1_TO_L2_VOICE_333  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L2_VOICE_333(P_PROCESS_DATE VARCHAR2) IS
   VCOUNT NUMBER;
    VDATE_KEY NUMBER;
    VSTATUS NUMBER;
...
BEGIN
      ...
      EXECUTE IMMEDIATE  'TRUNCATE TABLE L2_VOICE_333 DROP STORAGE';
        ...
        AND TO_CHAR(V.PROCESSED_DATE,'YYYYMMDD') = P_PROCESS_DATE;
        COMMIT;
        EXCEPTION
