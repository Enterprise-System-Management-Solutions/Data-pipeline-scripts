--
-- P_L1_TO_L2_VOICE_TEMP  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L2_VOICE_TEMP (P_PROCESS_DATE VARCHAR2) IS
    VCOUNT NUMBER;
    VDATE_KEY NUMBER;
    VSTATUS NUMBER;
    VSTATUS2 NUMBER;
...
BEGIN
  ...
  IF VCOUNT >= 1  THEN
    ...
    IF VSTATUS = 96 AND VSTATUS2= 96 THEN
        ...
        FROM  L1_VOICE_TEMP_FULL V,DATE_DIM B,DATE_DIM C
