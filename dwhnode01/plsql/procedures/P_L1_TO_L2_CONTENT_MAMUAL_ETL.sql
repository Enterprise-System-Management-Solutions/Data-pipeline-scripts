--
-- P_L1_TO_L2_CONTENT_MAMUAL_ETL  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L2_CONTENT_MAMUAL_ETL (P_PROCESS_DATE VARCHAR2) IS
VCOUNT NUMBER;
    VDATE_KEY NUMBER;
    VSTATUS NUMBER;
    VSTATUS2 number;
...
BEGIN
  ...
  IF VCOUNT >= 1  THEN
    ...
    IF VSTATUS = 96 and VSTATUS2=0 THEN
        ...
        AND TO_DATE(O.PROCESSED_DATE,'DD/MM/RRRR') = VDATE;
        COMMIT;
