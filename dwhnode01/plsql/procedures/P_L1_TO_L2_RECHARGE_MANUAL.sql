--
-- P_L1_TO_L2_RECHARGE_MANUAL  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L2_RECHARGE_MANUAL (P_PROCESS_DATE VARCHAR2) IS
    VCOUNT NUMBER;
    VDATE_KEY NUMBER;
    VSTATUS NUMBER;
...
BEGIN
        ...
        VALUES              ('L2_RECHARGE',VDATE_KEY,'vou','96',VCOUNT,'','',SYSDATE);
        commit;
EXCEPTION
