--
-- P_L1_TO_L2_TRANSFER_MANUAL  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L2_TRANSFER_MANUAL(P_PROCESS_DATE VARCHAR2) IS
    VCOUNT NUMBER;
    VDATE_KEY NUMBER;
    VSTATUS NUMBER;
...
BEGIN
        ...
        VALUES              ('L2_TRANSFER',VDATE_KEY,'transfer','96',VCOUNT,'','',SYSDATE);
        COMMIT;
EXCEPTION
