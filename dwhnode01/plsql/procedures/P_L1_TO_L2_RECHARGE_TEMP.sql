--
-- P_L1_TO_L2_RECHARGE_TEMP  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L2_RECHARGE_TEMP (P_PROCESS_DATE VARCHAR2) IS
    VCOUNT NUMBER;
    VDATE_KEY NUMBER;
    VSTATUS NUMBER;
    VSTATUS2 NUMBER;
...
BEGIN
  ...
  IF VCOUNT >= 1  THEN
    ...
    AND TABLE_NAME = 'L1_RECHARGE_TEMP'; 
    ...
    IF VSTATUS = 96 and VSTATUS2= 96 THEN
        ...
        RE490_PAYTYPE             ,
        RE501_AGENTNAME        
        FROM  L1_RECHARGE_TEMP_FULL A,DATE_DIM E,DATE_DIM C
