--
-- P_L1_TO_L2_MANAGEMENT_TEMP  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_L1_TO_L2_MANAGEMENT_TEMP (P_PROCESS_DATE VARCHAR2) IS
    VCOUNT NUMBER;
    VDATE_KEY NUMBER;
    VSTATUS NUMBER;
    VSTATUS2 NUMBER;
...
BEGIN
  ...
  IF VCOUNT >= 1  THEN
    ...
    AND TABLE_NAME = 'L1_MANAGEMENT_TEMP'; 
    ...
    IF VSTATUS = 96 and VSTATUS2= 96 THEN
        ...
        FROM  L1_MANAGEMENT_TEMP_FULL M,DATE_DIM B,DATE_DIM C
