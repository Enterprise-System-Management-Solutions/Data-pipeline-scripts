...
SET feedback off
WHENEVER SQLERROR EXIT SQL.SQLCODE
INSERT INTO L1_MSC_HUAWEI_DUMP(PROCESSED_DATE, FILE_NAME, MH01_CALLTYPE, MH02_SERVEDIMSI, MH03_SERVEDIMEI, MH04_APARTYMSISDN, MH05_BPARTYMSISDN, MH06_FORWARDINGMSISDN, MH07_ORIGINATIONTIME, MH08_CALLDURATION, MH09_CAUSEFORTERM, MH10_GLOBAAREAID, FILE_FLAG)
(SELECT TO_DATE(TO_CHAR(SYSDATE,'MM/DD/YYYY'),'MM/DD/YYYY'),'$1',MH01_CALLTYPE, MH02_SERVEDIMSI, MH03_SERVEDIMEI, MH04_APARTYMSISDN, MH05_BPARTYMSISDN, MH06_FORWARDINGMSISDN, MH07_ORIGINATIONTIME, MH08_CALLDURATION, MH09_CAUSEFORTERM, MH10_GLOBAAREAID, FILE_FLAG
 FROM MSC_HUAWEI_DUMP_EXI)
/
COMMIT
/
UPDATE cdr_head
