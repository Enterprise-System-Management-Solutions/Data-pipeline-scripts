...
SET feedback off
WHENEVER SQLERROR EXIT SQL.SQLCODE
INSERT INTO L1_MSC_HUAWEI(PROCESSED_DATE, FILE_NAME, MH1_CALLTYPE, MH2_IMSI, MH3_IMEI, MH4_APARTY, MH5_BPARTY, MH6_FORWARDING_MSISDN, MH7_ORIGINATION_TIME, MH8_CALL_DURATION, MH9_CAUSE_FOR_TERM, MH10_GLOBAAREA_ID)
(SELECT TO_DATE(TO_CHAR(SYSDATE,'MM/DD/YYYY'),'MM/DD/YYYY'),'$1',CALLTYPE, IMSI, IMEI, APARTY, BPARTY, FORWARDING_MSISDN, ORIGINATION_TIME, CALL_DURATION, CAUSE_FOR_TERM, GLOBAAREA_ID FROM MSC_HUAWEI_EXI)
/
COMMIT
/
UPDATE cdr_head
...
sh esms_msc_huawei_ext_merge.sh $v3
createSMSCUpdate $v3
insertSMSCUpdate $v3
