...
SET verify off
SET linesize 400
SELECT '/data02/msc_alu/process_dir'||','||'//data02/msc_alu/process_dir'||file_name||','||file_name||','||file_id
FROM cdr_head
...
lock=/data02/scripts/process/bin/l1_msc_alu  export lock
