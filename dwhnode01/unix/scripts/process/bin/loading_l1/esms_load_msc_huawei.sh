...
SET feedback off
WHENEVER SQLERROR EXIT SQL.SQLCODE
INSERT INTO L1_MSC_HUAWEI(PROCESSED_DATE, FILE_NAME, MH01_CALLTYPE, MH02_SERVEDIMSI, MH03_SERVEDIMEI, MH04_APARTYMSISDN, MH05_BPARTYMSISDN, MH06_FORWARDINGMSISDN, MH07_ORIGINATIONTIME, MH08_CALLDURATION, MH09_CAUSEFORTERM, MH10_GLOBAAREAID)
(SELECT TO_DATE(TO_CHAR(SYSDATE,'MM/DD/YYYY'),'MM/DD/YYYY'),'$1', MH01_CALLTYPE, MH02_SERVEDIMSI, MH03_SERVEDIMEI, MH04_APARTYMSISDN, MH05_BPARTYMSISDN, MH06_FORWARDINGMSISDN, MH07_ORIGINATIONTIME, MH08_CALLDURATION, MH09_CAUSEFORTERM, MH10_GLOBAAREAID FROM MSC_HUAWEI_EXI)
/
COMMIT
/
UPDATE cdr_head
