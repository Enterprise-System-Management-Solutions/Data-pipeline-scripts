...
SET verify off
SET linesize 400
SELECT '/data02/mfs/smsc/smsc_20200604/process_dir'||','||'/data02/mfs/smsc/smsc_20200604/process_dir'||file_name||','||file_name||','||file_id
FROM cdr_head
 WHERE source='smsc_20200604'
   AND process_status=30
   and rownum < 100 
/
EOF
...
SET feedback off
WHENEVER SQLERROR EXIT SQL.SQLCODE
INSERT INTO L1_SMSC_NEW(PROCESSED_DATE,FILE_NAME,SMC1_TIME_SERIAL_NUMBER,SMC2_SM_ID,SMC3_ORIGINAL_DELIVERY_ADDR,SMC4_TON_OF_ORIGINAL_DELIVE,SMC5_NPI_OF_ORIGINAL_DELIVE,SMC6_DESTINATION_DELIVERY_A,SMC7_TON_DESTINATION_DELIVE,SMC8_NPI_DESTINATION_DELIVE,SMC9_ORG_SUBMISSION_TIME,SMC10_FINAL_TIME,SMC11_SRR,SMC12_PID,SMC13_DCS,SMC14_SM_LENGTH,SMC15_SMSTATUS,SMC16_ERROR_CODE,SMC17_DESCRIPTION_PPS_USER,SMC18_CHARGEBILLPOINT,SMC19_MESSAGETYPE,SMC20_DELIVERCOUNT,SMC21_LASTERR,SMC22_UDHI,SMC23_RN,SMC24_MN,SMC25_SN,SMC26_MOMSCADDR,SMC27_MTMSCADDR,SMC28_ORGIMSI,SMC29_DESTIMSI,SMC30_ORGACCOUNT,SMC31_DESTACCOUNT,SMC32_MOSCADDRESS,SMC33_CELLID)
...
sh esms_create_mfs_ext_smsc_20200604.sh $v3
createSMSCUpdate $v3
insertSMSCUpdate $v3
