...
SET verify off
SET linesize 400
SELECT '/data02/cbs_cdrs/data/process_dir/'||','||'/data02/cbs_cdrs/data/process_dir/'||file_name||','||file_name||','||file_id
  FROM cdr_head
 WHERE source='data'
   AND process_status=30
--   and mod  (FILE_ID,3) = 1 
...
sh esms_create_cbs01_ext.sh $v3 
createSMSCUpdate $v3
insertSMSCUpdate $v3
