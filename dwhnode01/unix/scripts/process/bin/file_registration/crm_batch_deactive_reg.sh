...
DATE=$1
file='TABLE_6_HIS_BATCH_DEACTIVE_DATA'
XFILE="${file}"
type='crm_batch_deactive'
LIMIT=10
MINCOUNT=0
LDIR=/data02/crm_dump_dir/his_batch_deactive_data/
...
lock=/data02/scripts/process/bin/crm_batch_deactive  export lock
