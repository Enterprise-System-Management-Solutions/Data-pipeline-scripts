...
LIMIT=10000
MINCOUNT=1
LDIR='/data02/cbs_dump/voice/merge_dir/'
...
values(FILE_ID.nextval,'$1',30,SYSDATE,'voice',$2)
/
COMMIT
/
EXIT
...
lock=/data02/scripts/process/bin/file_registration/reg_to_process/dump/reg_merge_voice_dump  export lock
...
for fil in $fileList
do
echo "moving from /data02/cbs_dump/voice/merge_dir/  to /data02/cbs_dump/voice/dump_dir for ${fil}"
##pre_count for every files
pc1=`cat $LDIR/$fil | wc -l`


mv $LDIR/$fil /data02/cbs_dump/voice/dump_dir/$fil
