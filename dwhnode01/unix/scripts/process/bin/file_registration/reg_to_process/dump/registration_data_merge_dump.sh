...
LIMIT=10000
MINCOUNT=1
LDIR='/data02/cbs_dump/data/merge_dir/'
...
lock=/data02/scripts/process/bin/file_registration/reg_to_process/dump/reg_merge_data_dump  export lock
...
for fil in $fileList
do
echo "moving from /data02/cbs_dump/data/merge_dir/  to /data02/cbs_dump/data/dump_dir for ${fil}"
##pre_count for every files
pc1=`cat $LDIR/$fil | wc -l`


mv $LDIR/$fil /data02/cbs_dump/data/dump_dir/$fil
