...
lock=/data02/scripts/process/bin/cbs_voice_file_merge_manual  export lock
...
cd /data02/cbs_cdrs/voice/process_dir
...
mv cbs_cdr_voice_$dt.add /data02/cbs_cdrs/voice/merge_dir
